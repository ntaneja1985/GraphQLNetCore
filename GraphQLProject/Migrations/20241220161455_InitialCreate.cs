...
namespace GraphQLProject.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CustomerName", "PartySize", "PhoneNumber", "ReservationDate", "SpecialRequest" },
                values: new object[,]
                {
                    { 1, "John Doe", 2, "555-123-4567", new DateTime(2024, 12, 27, 21, 44, 55, 636, DateTimeKind.Local).AddTicks(808), "No nuts in the dishes, please." },
                    { 2, "Jane Smith", 4, "555-987-6543", new DateTime(2024, 12, 30, 21, 44, 55, 636, DateTimeKind.Local).AddTicks(6984), "Gluten-free options required." },
                    { 3, "Michael Johnson", 6, "555-789-0123", new DateTime(2025, 1, 3, 21, 44, 55, 636, DateTimeKind.Local).AddTicks(6995), "Celebrating a birthday." }
                });
